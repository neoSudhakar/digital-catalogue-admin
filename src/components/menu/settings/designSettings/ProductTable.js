...
const handleDeleteRow = (rowToDelete) => {
    ...
    const columnDefs=[
        ...
        { headerName: 'Product', field: 'name', width:450 },
        {
            headerName: "Actions",
            width:700,
            cellRenderer: (params) => (
    ...
    return(
        <div style={{margin: 15}}>
            ...
            <UpdateModal openModal={isModalOpen} closeModal= {handleCloseModal} title={"UPDATE PRODUCT"}>
                <Product refetchData={refetch} closeModal={handleCloseModal} selectedRow={selectedRow}/>
            </UpdateModal>
        </div>
    )
};