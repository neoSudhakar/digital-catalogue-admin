...
import classes from "../Manufacturers/ManufacturersPermissions.module.css"
import MultipleSelect from '../../../../UI/select-multiple/MultipleSelect';

export default function RetailersPermissions() {
    ...
    const DUMMY_FEATURE_PERMISSIONS ={
      ...
      Catalogue: {view: false, edit: false, delete: false},
